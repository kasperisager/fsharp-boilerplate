...
[`src/Application/Program.fs`](src/Application/Program.fs) | This type is the main entry point to your application and its `Main()` method will be executed when the application is run.
...
__`test`__ - Run test specifications using [DNX](https://github.com/aspnet/dnx), [xUnit](http://xunit.github.io/), and [FsUnit](http://fsprojects.github.io/FsUnit).
